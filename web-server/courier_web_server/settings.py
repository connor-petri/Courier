"""
Django settings for courier_web_server project.
...
SECRET_KEY = 'django-insecure--8#mxp5hpps0#0ys+ct9yn3=%5-1+^2^ph3&q&#nr$u&0bg5$s'
...
WSGI_APPLICATION = 'courier_web_server.wsgi.application'
